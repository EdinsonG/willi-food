          ...
          <v-flex sm6 lg6>
            ...
            >
              ...
              <v-date-picker v-model="startDate" no-title scrollable>
                ...
                <v-btn text color="primary" @click="$refs.startDate.save(startDate)">OK</v-btn>
              </v-date-picker>
            </v-menu>
          </v-flex>
          <v-flex sm6 lg6>
            ...
            >
              ...
              <v-time-picker v-model="startTime">
                ...
                <v-btn text color="primary" @click="$refs.startTime.save(startTime)">OK</v-btn>
              </v-time-picker>
            </v-menu>
          </v-flex>
          <v-flex sm6 lg6>
            ...
            >
              <template v-slot:activator="{ on }">
                <v-text-field label="End Date" v-model="endDate" append-icon="event" readonly v-on="on"></v-text-field>
              </template>
              <v-date-picker v-model="endDate" no-title scrollable>
                <v-spacer></v-spacer>
                <v-btn text color="primary" @click="endDateMenu = false">Cancel</v-btn>
                <v-btn text color="primary" @click="$refs.endDate.save(endDate)">OK</v-btn>
              </v-date-picker>
            </v-menu>
          </v-flex>
          <v-flex sm6 lg6>
            ...
            >
              ...
              <v-time-picker v-model="endTime">
                ...
                <v-btn text color="primary" @click="$refs.endTime.save(endTime)">OK</v-btn>
              </v-time-picker>
            </v-menu>
          </v-flex>
          <v-flex lg12 sm12>
