              ...
              <v-dialog v-model="dialog" max-width="500px">
                ...
                <v-card>
                  <v-card-title color="primary">
                    <span>Editar cuenta {{editedItem.id}}</span>
                  </v-card-title>
                  <v-card-text>
                    <v-row>
                      <v-col cols="12" sm="12">
                        <v-text-field v-model="editedItem.name_bank" label="Nombre del banco"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="12">
                        <v-text-field v-model="editedItem.account_number" :counter="20" label="Número de cuenta"></v-text-field>
                      </v-col>                     
                    </v-row>
                  </v-card-text>
                  <v-card-actions>
