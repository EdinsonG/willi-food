              ...
              <v-dialog v-model="dialog" max-width="500px">
                ...
                <v-card>
                  <v-card-title color="primary">
                    <span v-if="editedItem.id">Editar sucursal {{editedItem.id}}</span>
                  ...
                  <v-card-text>
                    <v-row>
                      ...
                      <v-col cols="12" sm="8">
                        <v-text-field v-model="editedItem.pickup" label="Pickup"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="12">
                        <v-text-field v-model="editedItem.delivery" label="Delivery"></v-text-field>
                      </v-col>
                    </v-row>
                  </v-card-text>
                  <v-card-actions>
